...
const String txtLoginFailed = 'Unable to log in with provided credentials.';
const String txtLoginSucess = 'You are successfully logged in.';
const String txtLoginValidEmail = 'Enter a valid email address.';
